...
`;
        ...
        function logic() {
          ...
          if (sendButton && inputFields.length == 1) {
            const toolBar =
              sendButton.parentNode.parentNode.parentNode.parentNode;
            const container =
              toolBar.parentNode.parentNode.parentNode.parentNode.parentNode
      ...
      function (require, module, exports) {
        module.exports = {
          ...
          "trigram-unicodemap": {
            ...
            Arabic: { arabic: 724, farsi: 706, pashto: 677, urdu: 682 },
            "Latin Extended-B": { azeri: 73, hausa: 8, vietnamese: 19 },
            "Latin Extended-A": {
              azeri: 25,
              croatian: 10,
              czech: 27,
            ...
            "Combining Diacritical Marks": { azeri: 1 },
            Bengali: { bengali: 714 },
            Gujarati: { bengali: 16 },
            Gurmukhi: { bengali: 6 },
            Cyrillic: {
            ...
            Devanagari: { hindi: 693, nepali: 757 },
            "Latin Extended Additional": { vietnamese: 97 },
          },
        };
      },
      {},
    ...
    37: [
      function (require, module, exports) {
        ...
        LanguageDetect.prototype = {
          ...
          distance: function (arr1, arr2) {
            ...
            for (i = keys.length; i--; ) {
              sumdist += arr1[keys[i]]
                ? Math.abs(arr2[keys[i]] - arr1[keys[i]])
                : me.threshold;
            }
          ...
          detect: function (sample, limit) {
            ...
            for (i = keys.length; i--; ) {
              var score = me.normalizeScore(
                me.distance(me.langDb[keys[i]], trigramFreqs),
                trigramCount
              );
      ...
      { "../data/lang.json": 33, "./ISO639": 36, "./Parser": 38 },
    ],
    38: [
      function (require, module, exports) {
          ...
          analyze: function () {
            ...
            while (byteCounter < len) {
              ...
              if (this.compileTrigram) {
                if (!(b == " " && (a == " " || c == " "))) {
                  var abc = a + b + c;
                  this.trigram[abc] = this.trigram[abc]
                    ? (this.trigram[abc] += 1)
                    : 1;
                }
            ...
            if (this.compileUnicode) {
              ...
              for (var i = keysLength; i--; ) {
                ...
                this.unicodeBlocks[blockName] = this.unicodeBlocks[blockName]
                  ? (this.unicodeBlocks[blockName] += count)
                  : count;
              }
            }
            ...
            if (this.compileTrigram) {
              ...
              if (b != " ") {
                var ab = a + b + " ";
                this.trigram[ab] = this.trigram[ab]
                  ? (this.trigram[ab] += 1)
                  : 1;
              }
          ...
          return {
            ...
            createCompletion: (
              ...
              __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarPath = `/engines/{engine_id}/completions`.replace(
                  `{${"engine_id"}}`,
            ...
            createEmbedding: (engineId, createEmbeddingRequest, options = {}) =>
              __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarPath = `/engines/{engine_id}/embeddings`.replace(
                  `{${"engine_id"}}`,
                  encodeURIComponent(String(engineId))
                );
                // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        exports.OpenAIApiFp = function (configuration) {
          ...
          return {
            ...
            createCompletionFromModel(
              ...
              return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs =
                  yield localVarAxiosParamCreator.createCompletionFromModel(
                    createCompletionFromModelRequest,
                    options
                  );
                return common_1.createRequestFunction(
